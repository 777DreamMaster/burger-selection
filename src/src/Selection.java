...
public class Selection {
    public static void main(String[] args) throws Exception {
        ...
        String next,next1;
        while (true){
            System.out.println("Enter 1 to begin or continue, 0 to end:");
            next=enter.next();
            switch (next){
                case "1":{
                    while (true){
    ...
    public static void predictions() throws Exception{
        ...
        System.out.println("1-SaveModel  2-PrintModel  other-return to the main menu");
    ...
    public static void newCustomer() throws IOException{
        ...
        newCust.append("\n");
        printAtribute(sc, newCust,1,5,"1. Enter the nationality of customer:","1-Russian 2-Tatar 3-Ukranian 4-Kazakh 5-Belarusian");
        ...
        printAtribute(sc, newCust,1,3,"5. Enter physique of customer:","1-fat 2-fit 3-thin");
        printAtribute(sc, newCust,1,3,"6. Enter mood of customer:","1-funny 2-sad 3-pensive");
        printAtribute(sc, newCust,0,0,"7. Enter the customer's choice:","1-Chickenburger 2-Hamburger 3-Cheeseburger");
                ...
                if (from==to) {
                    switch (a){
                        case "1" :newCust.append("'chickenburger'");
                            break;
                        case "2" :newCust.append("'hamburger'");
                            break;
